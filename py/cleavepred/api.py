...
class CleavagePredictor(object):
    ...
    def predict(self, seq, extra_tracks_data = {}):
        ...
        @param extra_tracks_data (dict, empty by default): A dictionary for providing extra tracks of the given peptide. If using the simple
        ...
        1. cleavage_mask - A binary string (of 0's and 1's) representing whether each residue is a cleavage site (1) or not (0). The length
